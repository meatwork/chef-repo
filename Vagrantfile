...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "myops-starter"
  ...
  # and the path to the validation key (relative to this Vagrantfile).
   ...
   config.vm.provision :chef_client do |chef|
     chef.chef_server_url = "https://api.opscode.com/organizations/piole"
     chef.validation_client_name = "piole-validator"
     chef.validation_key_path = ".chef/piole-validator.pem"
   end
end
